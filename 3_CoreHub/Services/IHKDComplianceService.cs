...
namespace VanAn.CoreHub.Services
{
    ...
    public record HKDTransactionComplianceResult
    {
        ...
        public bool IsCompliant { get; init; }
        public List<TransactionViolation> Violations { get; init; } = [];
        public List<TransactionWarning> Warnings { get; init; } = [];
        public DateTime ValidationDate { get; init; }
    }
    ...
    public record HKDComplianceReport
    {
        ...
        public decimal ComplianceScore { get; init; }
        public List<ComplianceSummary> Summaries { get; init; } = [];
        public List<ComplianceTrend> Trends { get; init; } = [];
    ...
    public record MultiTenantComplianceResult
    {
        ...
        public List<DataIsolationViolation> Violations { get; init; } = [];
