...
public record HKDTaxReport
{
    ...
    public List<string> SpecialTaxCategories { get; init; } = new();
    public List<string> TaxAuthorityReferences { get; init; } = new();
    public List<string> RevenueCategories { get; init; } = new();
    public List<string> ProductCategories { get; init; } = new();
    public List<TransactionRecord> RevenueBreakdown { get; init; } = new();
    public List<TransactionRecord> ExpenseBreakdown { get; init; } = new();
    public List<TransactionRecord> InventoryBreakdown { get; init; } = new();
    public List<TransactionRecord> PaymentMethodBreakdown { get; init; } = new();
...
public record ReportData
{
    ...
    public List<TransactionRecord> Transactions { get; init; } = new();
    public List<TaxBreakdownRecord> TaxBreakdowns { get; init; } = new();
    public Dictionary<string, decimal> AccountSummaries { get; init; } = new();
}
...
public record ReportFormat
{
    ...
    public List<string> SupportedBookTypes { get; init; } = new();
    public Dictionary<string, string> FormatOptions { get; init; } = new();
}
...
public record ReportFormatValidationResult
{
    ...
    public List<FormatValidationError> Errors { get; init; } = new();
    public List<FormatValidationError> ValidationErrors { get; init; } = new();
    public List<FormatValidationWarning> Warnings { get; init; } = new();
...
public record ReportTemplate
{
    ...
    public List<TemplateSection> TemplateSections { get; init; } = new();
    public List<TaxReportField> Fields { get; init; } = new();
    public List<TemplateFormula> Formulas { get; init; } = new();
...
public record HKDQuarterlyTaxSummary
{
    ...
    public List<MonthlySummary> MonthlySummaries { get; init; } = new();
    public DateTime GeneratedDate { get; init; }
}
...
public record HKDAnnualTaxSummary
{
    ...
    public List<QuarterlySummary> QuarterlySummaries { get; init; } = new();
