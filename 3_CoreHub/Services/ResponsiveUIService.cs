...
namespace VanAn.CoreHub.Services
{
    ...
    /// </summary>
    public class ResponsiveUIService(ILogger<ResponsiveUIService> logger, IMemoryCache cache) : IResponsiveUIService
    {
        private readonly ILogger<ResponsiveUIService> _logger = logger;
        ...
        public async Task<ResponsiveLayout> GetLayoutConfigAsync(DeviceInfo device)
        {
            ...
            try
            {
                ...
                ResponsiveLayout layout = device.Type switch
                {
        ...
        public async Task<ComponentSizes> GetComponentSizesAsync(ScreenSize screen)
        {
            ...
            try
            {
                ...
                ComponentSizes sizes = screen.Width switch
                {
        ...
        public async Task<bool> IsTouchEnabledAsync(DeviceType deviceType)
        {
            ...
            try
            {
                ...
                bool isTouchEnabled = deviceType switch
                {
        ...
        public async Task<NavigationPattern> GetNavigationPatternAsync(DeviceInfo device)
        {
            ...
            try
            {
                ...
                NavigationPattern pattern = device.Type switch
                {
        ...
        public async Task<float> GetFontScaleAsync(UserPreferences preferences)
        {
            ...
            try
            {
                ...
                float fontScale = preferences.Language switch
                {
        ...
        public async Task<ColorTheme> GetColorThemeAsync(DeviceInfo device, UserPreferences preferences)
        {
            ...
            try
            {
                ...
                ColorTheme theme = preferences.Theme.ToLower(CultureInfo.InvariantCulture) switch
                {
                    "dark" => GetDarkTheme(),
                    "light" => GetLightTheme(),
        ...
        public async Task<AnimationSettings> GetAnimationSettingsAsync(DeviceInfo device)
        {
            ...
            try
            {
                ...
                AnimationSettings settings = device.Type switch
                {
