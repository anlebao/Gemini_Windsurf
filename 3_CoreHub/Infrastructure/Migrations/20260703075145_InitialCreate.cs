        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasInstalledApp = table.Column<bool>(type: "INTEGER", nullable: false),
                    AppInstalledAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    AppVersion = table.Column<string>(type: "TEXT", nullable: true),
                    DeviceType = table.Column<string>(type: "TEXT", nullable: true),
                    WelcomeEmailSent = table.Column<bool>(type: "INTEGER", nullable: false),
                    WelcomeEmailSentAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    WelcomeSMSsent = table.Column<bool>(type: "INTEGER", nullable: false),
                    WelcomeSMSsentAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LoyaltyProgramActivated = table.Column<bool>(type: "INTEGER", nullable: false),
                    LoyaltyActivatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByStaffId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PushSubscriptionId = table.Column<Guid>(type: "TEXT", nullable: false, defaultValueSql: "newid()"),
                    CustomerId = table.Column<Guid>(type: "TEXT", nullable: false),
                    SubscriptionJson = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    UserAgent = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    LastUsedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    ExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ActivityDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CustomerOnboardingId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnboardingActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OnboardingActivities_CustomerOnboardings_CustomerOnboardingId",
