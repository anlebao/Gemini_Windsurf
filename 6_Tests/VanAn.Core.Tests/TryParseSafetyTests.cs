...
namespace VanAn.Core.Tests
{
    public class TryParseSafetyTests
    {
        ...
        {
            // Arrange
            string validGuidString = "11111111-1111-1111-1111-111111111111";

            // Act
            bool result = Guid.TryParse(validGuidString, out Guid parsedGuid);
        ...
        public void GuidTryParse_InvalidInput_ReturnsFalse()
        {
            ...
            // Act
            bool result = Guid.TryParse(invalidGuidString, out Guid parsedGuid);
        ...
        {
            // Arrange & Act
            bool result = Guid.TryParse(null, out Guid parsedGuid);
        ...
        public void GuidTryParse_EmptyInput_ReturnsFalse()
        {
            ...
            // Act
            bool result = Guid.TryParse(emptyInput, out Guid parsedGuid);
        ...
        {
            // Arrange
            string validIntString = "12345";

            // Act
            bool result = int.TryParse(validIntString, out int parsedInt);
        ...
        {
            // Arrange
            string invalidIntString = "not-an-integer";

            // Act
            bool result = int.TryParse(invalidIntString, out int parsedInt);
        ...
        {
            // Arrange & Act
            bool result = int.TryParse((string?)null, out int parsedInt);
        ...
        public void IntTryParse_EmptyInput_ReturnsFalse()
        {
            ...
            // Act
            bool result = int.TryParse(emptyInput, out int parsedInt);
        ...
        {
            // Arrange
            string overflowInput = "999999999999999999999999999999";

            // Act
            bool result = int.TryParse(overflowInput, out int parsedInt);
        ...
        {
            // Arrange
            string validDateString = "2026-04-03";

            // Act
            bool result = DateTime.TryParse(validDateString, out DateTime parsedDate);
        ...
        public void DateTimeTryParse_InvalidInput_ReturnsFalse()
        {
            ...
            // Act
            bool result = DateTime.TryParse(invalidDateString, out DateTime parsedDate);
        ...
        {
            // Arrange & Act
            bool result = DateTime.TryParse(null, out DateTime parsedDate);
        ...
        public void DateTimeTryParse_EmptyInput_ReturnsFalse()
        {
            ...
            // Act
            bool result = DateTime.TryParse(emptyInput, out DateTime parsedDate);
        ...
        {
            // Arrange
            string validRoleString = "Owner";

            // Act
            bool result = Enum.TryParse(validRoleString, out UserRole parsedRole);
        ...
        {
            // Arrange
            string invalidRoleString = "InvalidRole";

            // Act
            bool result = Enum.TryParse(invalidRoleString, out UserRole parsedRole);

            // Assert
            Assert.False(result);
            Assert.Equal(default, parsedRole);
        }
        ...
        {
            // Arrange
            string lowercaseRoleString = "owner";

            // Act
            bool result = Enum.TryParse(lowercaseRoleString, true, out UserRole parsedRole);
