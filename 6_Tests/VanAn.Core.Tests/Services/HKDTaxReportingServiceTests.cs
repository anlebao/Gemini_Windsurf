...
public class HKDTaxReportingServiceTests : IDisposable
{
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S1a_HKD;

        // Act
        var result = await _service.GenerateTaxReportAsync(_testTenantId, bookType, _testPeriod);
        ...
        Assert.Contains("tax exemption", result.ReportTitle.ToLower());
    }
    ...
    public async Task GetReportFormatsAsync_S1aHKD_ShouldReturnTaxExemptionFormats()
    {
        ...
        // Act
        var result = await _service.GetReportFormatsAsync(bookType);
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S2a_HKD;
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S2b_HKD;
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S2c_HKD;
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S2d_HKD;
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S2e_HKD;
    ...
    {
        // Arrange
        var bookType = AccountingBookType.S3a_HKD;
        ...
        Assert.Contains("special tax", result.ReportTitle.ToLower());
    ...
    public async Task ExportTaxReportAsync_ShouldReturnExcelBytes()
    {
        // Arrange
        var bookType = AccountingBookType.S1a_HKD;
        var report = await _service.GenerateTaxReportAsync(_testTenantId, bookType, _testPeriod);
        var format = new ReportFormat { FormatId = "EXCEL", FormatType = "Excel", Extension = ".xlsx" };

        // Act
        var result = await _service.ExportTaxReportAsync(report, format);
    ...
    public async Task ExportTaxReportAsync_ShouldReturnCSVBytes()
    {
        ...
        var bookType = AccountingBookType.S1a_HKD;
        var report = await _service.GenerateTaxReportAsync(_testTenantId, bookType, _testPeriod);
        var format = new ReportFormat { FormatId = "CSV", FormatType = "CSV", Extension = ".csv" };
    ...
    public async Task ValidateReportFormatAsync_ShouldReturnValidResult()
    {
        ...
        // Act
        var result = await _service.ValidateReportFormatAsync(report, format);
    ...
    public async Task GetReportTemplateAsync_ShouldReturnValidTemplate()
    {
        ...
        // Act
        var result = await _service.GetReportTemplateAsync(bookType, format);
