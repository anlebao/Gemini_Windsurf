...
namespace VanAn.Core.Tests.Accounting
{
    public class AccountCodeValidationTests
    {
        ...
        {
            // Act
            bool isValid = AccountCodeValidator.IsValidVNAccountCode(accountCode);
        ...
        public void GetAccountType_ShouldReturnRevenue_For5xxCodes()
        {
            ...
            // Act
            AccountType accountType = AccountCodeValidator.GetAccountType(accountCode);
