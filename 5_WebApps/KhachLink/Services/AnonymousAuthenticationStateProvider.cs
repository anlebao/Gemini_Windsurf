...
namespace VanAn.KhachLink.Services
{
    ...
    /// KhachLink is a customer-facing PWA with no server-side auth â€” tenant context
    ...
    /// so TenantService.GetCurrentTenantId() returns Guid.Empty â€” callers fall back
