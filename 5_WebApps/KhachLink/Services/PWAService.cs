...
public class PWAService : IAsyncDisposable
{
    ...
    public async Task InitializeAsync()
    {
        try
        {
            ...
            _isInstalled = await _jsRuntime.InvokeAsync<bool>("vananPWA.isInstalled");
            
            // Check online status
            _isOnline = await _jsRuntime.InvokeAsync<bool>("vananPWA.isOnline");
    ...
    public async Task<bool> ShowInstallPromptAsync()
    {
        try
        {
            ...
            var result = await _jsRuntime.InvokeAsync<bool>("vananPWA.showInstallPrompt");
    ...
    public async Task<bool> RequestNotificationPermissionAsync()
    {
        try
        {
            var permission = await _jsRuntime.InvokeAsync<string>("vananPWA.requestNotificationPermission");
    ...
    public async Task<string?> SubscribeToPushAsync()
    {
        try
        {
            var subscription = await _jsRuntime.InvokeAsync<string>("vananPWA.subscribeToPush");
