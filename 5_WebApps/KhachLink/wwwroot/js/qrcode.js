...
// === VanAn Interop API (appended to official qrcode-generator) ===
// Exposes: vananQR.generate(elementId, text, width, height)
//          vananQR.download(elementId, filename)
//          vananQR.generateDataUrl(text, size) — returns data URL string
window.vananQR = {
