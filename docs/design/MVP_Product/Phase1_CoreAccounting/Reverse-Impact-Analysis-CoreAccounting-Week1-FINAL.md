...
### 2.1 Files to Create / Files to Modify

| Action | File Path | Purpose | Impact |
|--------|-----------|---------|--------|
| **CREATE** | `1_Shared/Domain.cs` (add to existing) | Add accounting Value Objects | HIGH |
| **CREATE** | `3_CoreHub/Domain/AccountingEntry.cs` | Immutable core entity | HIGH |
| **CREATE** | `3_CoreHub/Domain/CompanyAccountingEntry.cs` | Extended company entity | HIGH |
| **CREATE** | `3_CoreHub/Domain/AccountingEntryFactory.cs` | Factory pattern | HIGH |
| **MODIFY** | `3_CoreHub/Infrastructure/VanAnDbContext.cs` | Add AccountingEntry DbSet | HIGH |
| **CREATE** | `3_CoreHub/Infrastructure/Configurations/AccountingEntryConfiguration.cs` | EF Core config | HIGH |
| **CREATE** | `3_CoreHub/Repositories/IAccountingEntryRepository.cs` | Repository interface | MEDIUM |
| **CREATE** | `3_CoreHub/Repositories/AccountingEntryRepository.cs` | Repository implementation | MEDIUM |
| **CREATE** | `3_CoreHub/Services/AccountingEntryService.cs` | Service layer | MEDIUM |
| **CREATE** | `3_CoreHub/Services/HKDBookService.cs` | 4 HKD books service | MEDIUM |
| **CREATE** | `3_CoreHub/Services/ReversalService.cs` | Reversal logic | MEDIUM |
| **CREATE** | `2_Gateway/Controllers/AccountingEntriesController.cs` | API controller | LOW |
| **CREATE** | `6_Tests/VanAn.Core.Tests/Domain/AccountingEntryTests.cs` | Unit tests | MEDIUM |
| **CREATE** | `6_Tests/VanAn.Core.Tests/Integration/AccountingEntryIntegrationTests.cs` | Integration tests | MEDIUM |

### 2.2 Existing Domain Structure
...
### 2.4 Current Outbox Pattern Status
...
**What will be tested:**
- AccountingEntry creation (revenue, expense, reversal)
- Value Object validation (AccountingPeriod, Money)
- Factory method validation and business rules
- Immutable property enforcement
- Reversal entry creation with proper linking

#### 6.1.2 Service Layer Tests
**What will be tested:**
- AccountingEntryService Create methods
- ReversalService reversal logic
...
**What will be tested:**
- AddAsync functionality
- GetByIdAsync and GetByTenantAsync queries
- Multi-tenant data isolation
- EF Core ValueObject conversions
...
**What will be tested:**
- Database persistence of AccountingEntry
...
- Automatic AccountingEntry generation
- 4 HKD books creation
...
- Tenant-specific accounting flows
- Authentication and authorization
- Performance under multi-tenant load

### 6.4 Test Coverage Targets
- **Unit Tests**: 80%+ coverage of domain and service logic
- **Integration Tests**: 60%+ coverage of data persistence
- **E2E Tests**: Critical business path coverage
...
- [ ] Code follows Vân An coding standards
...
*This analysis serves as the foundation for Week 1 implementation. All technical work must strictly follow this plan and the Vân An architectural rules.*
...
### 11.3 Process Review
- [ ] Follows Vân An development process
