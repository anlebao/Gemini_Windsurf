...
* **Last Updated:** 2026-07-05 — **STREAM G W2 COMPLETE & MERGED (`e148b6a`)**. Package security: removed 9 legacy 2.3.0 auth packages, FrameworkReference for .NET 8 shared framework, global.json SDK pin. SDK 8.0.100→8.0.22+ needs user manual install. 1114/1114 tests PASS. **NEXT:** W3 (CI Pipeline Restore).
