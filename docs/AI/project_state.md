...
- **Sprint 1 (Blockers) COMPLETE ✅ (W0-W3, all merged to main):**
  ...
  - **W2:** 9 legacy auth packages removed (SDK 8.0.422 installed user-local but NOT resolved by system dotnet — PATH/multilevel lookup issue, CVEs unpatched in active build)
...
3. ~~W2: Package Security~~ ✅ DONE & MERGED (SDK 8.0.422 installed user-local but NOT resolved by system dotnet — PATH fix needed)
