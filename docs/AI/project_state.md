...
- Next: **RV on production** — ✅ Layer 1+3 PASS on diemthuong2 (FullCommerce). Gaps: Directory-profile WASM domain (timlathay.com uses SSR), Reseller badge (needs login), P1.1 confirm dialog (needs SystemAdmin auth — manual RV).
