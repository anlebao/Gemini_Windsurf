...
1. **[NEXT — Start now]** KhachLink-W2: QR Code Scanning (branch: `feature/khachlink-wave2-qr-scanning`) - Implement per task card with in-app camera scanning
...
* **Current Branch:** `main`
* **Unified Roadmap (2026-06-29):** 4/8 waves complete (50%). Layer 0 (ADR001-W2, W3) + Layer 1 (KhachLink-W1) infrastructure + UX foundation DONE. Next: KhachLink-W2 (QR Code Scanning - in-app camera). Open decision before Wave 7: PushSubscription storage strategy.
