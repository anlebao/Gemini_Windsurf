...
- **Branch:** `main` @ `2c3e0360` (Realtime Platform P2 — generic Domain/services + PG migration. P1b GPS map + Free/Charity checkout. Community Commerce Batch 1 + 2 + Chat + GPS + referral QR + commission base/self-referral. KhachLink Profile Sprint 1+2. GTM W2 + currency fix. W1 Merchant Audit + nginx Directory SSR. R2.2 Reseller Accounting — PR #169. Crawl-to-Onboard 8 phases. Issue #103/#157/#161/#156 deployed).
...
> **Last Updated:** 2026-09-17 · **Branch:** `main` @ `2c3e0360` (Realtime Platform P2 committed + deployed + RV L1 PASS)
