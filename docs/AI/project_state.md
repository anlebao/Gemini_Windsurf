...
- **Branch:** `main`
- **Last commit:** `743c32dd` fix(loyalty): Bug 6 — IgnoreQueryFilters for customer/rewards lookup
- **.NET SDK:** 8.0.422
- **DB:** SQLite `vanan_shoperp.db` (business) + PostgreSQL `VanAnCoreHub` (accounting + Gateway + Community tables)
- **Build (2026-07-27):** 0 errors, 1014 warnings (pre-existing CA). CD #30244616529 ALL PASS (Build & Push 3m51s + Validation 11s + Deploy 1m18s). VPS RV: 3/3 services healthy.
