...
**SALESMAN REFERRAL QR — CORRECT DOMAIN + SCAN-TO-BUY + COMMISSION — ✅ COMPLETE + DEPLOYED + RV PASS (session 2026-09-16/17, commit `aceab325`).**
...
- **Salesman Referral QR (session 2026-09-16/17):** ✅ correct domain + scan-to-buy + commission — DEPLOYED + RV PASS (`aceab325`). HEAD=`aceab325`.
