# TASK CARD: PRODUCTION_HYGIENE - WAVE12 - Audit ShopERP API Authorization

## 1. GOAL & CONTEXT
- **Mục tiêu cốt lõi:** Audit tất cả API endpoints trong ShopERP cho authorization
- **Nghiệp vụ áp dụng:** Security audit - verify all ShopERP endpoints have proper authorization
...
- **Files được phép đọc/sửa:**
  ...
  - `5_WebApps/ShopERP/Controllers/*.cs` (audit only)
...
- [ ] **Comprehensive Audit:** Audit tất cả Controllers trong ShopERP
...
- [ ] **SC1:** Audit hoàn thành cho tất cả ShopERP Controllers
...
- [ ] **SC6:** PRODUCTION_HYGIENE_master_plan.md updated với W12-T2 status = ✅ DONE
...
- **Evidence Count:** 2
- **Verified Facts:**
  - Fact 1: ShopERP có nhiều Controllers (CustomersController, ProductsController, etc.)
  - Fact 2: CustomersController đã xóa trong Wave 9
- **Assumptions:**
  - ShopERP endpoints should have authorization
- **Open Questions:**
  - Q1: Có bao nhiêu endpoints thiếu authorization?
  - Q2: Có legitimate public endpoints không?
- **Recommended Action:** Comprehensive audit of all ShopERP Controllers
...
- **Audit Strategy:** Read all ShopERP Controllers, analyze authorization attributes
- **Test boundary:**
  - Unit tests: N/A
...
Comprehensive audit of all ShopERP Controllers for authorization status.

### Micro-phase breakdown cho WAVE12 - Audit ShopERP Authorization

| Session | JIT Planning (chốt gì) | Pure Execution (viết gì) |
|---|---|---|
| **S1** | List all ShopERP Controllers | Find all Controllers in 5_WebApps/ShopERP/Controllers/ |
