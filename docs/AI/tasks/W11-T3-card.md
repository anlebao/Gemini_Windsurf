# TASK CARD: PRODUCTION_HYGIENE - WAVE11 - Delete KhachLink Demo Index Renamed

## 1. GOAL & CONTEXT
- **Mục tiêu cốt lõi:** Xóa KhachLink/wwwroot/demoIndex.html - renamed demo, vẫn không cần thiết
...
- **Files được phép đọc/sửa:**
  ...
  - `5_WebApps/KhachLink/wwwroot/demoIndex.html` (xóa)
...
- [ ] **Demo File:** File là renamed demo cũ với vanilla JavaScript
...
- [ ] **SC1:** KhachLink/wwwroot/demoIndex.html đã xóa khỏi repository
- [ ] **SC2:** Không có code references đến demoIndex.html
...
- [ ] **SC7:** PRODUCTION_HYGIENE_master_plan.md updated với W11-T3 status = ✅ DONE
...
- **Evidence Count:** 3
- **Verified Facts:**
  - Fact 1: KhachLink/wwwroot/demoIndex.html là renamed demo cũ
...
|---|---|---|
| demoIndex.html (xóa) | Không có reverse impact | KhachLink uses Blazor Pages |
...
Delete renamed demo file, verify no references, update documentation.

### Micro-phase breakdown cho WAVE11 - Delete KhachLink Demo Index Renamed

| Session | JIT Planning (chốt gì) | Pure Execution (viết gì) |
|---|---|---|
| **S1** | Verify no references to demoIndex.html | Execute grep search, analyze results, confirm safe to delete |
| **S2** | Delete demoIndex.html file | Execute file deletion, verify file removed |
