...
### Track E1 (Sync Fix)
- [ ] T1 evidence: SQLite Orders count = 0 sau checkout (reproduce broken)
...
- [ ] T6 evidence: SQLite Orders +1 sau checkout, với đúng ProductName + VatRate
- [ ] Dashboard `todayOrders >= 1` sau checkout
- [ ] Build 0 errors
