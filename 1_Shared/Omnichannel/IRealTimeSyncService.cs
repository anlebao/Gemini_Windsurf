...
public record PublishResult
{
    ...
    public List<string> SuccessfulDevices { get; init; } = new();
    public List<DeliveryError> FailedDeliveries { get; init; } = new();
...
public record InventorySyncStatus
{
    ...
    public List<string> PendingDevices { get; init; } = new();
...
public record ForceSyncResult
{
    ...
    public List<string> SuccessfulDevices { get; init; } = new();
    public List<SyncError> FailedDevices { get; init; } = new();
    ...
    public string SyncVersion { get; init; } = string.Empty;
    public List<RealTimeSyncConflict> ResolvedConflicts { get; init; } = new();
}
...
public record RealTimeSyncAnalytics
{
    ...
    public Dictionary<string, int> UpdatesByDevice { get; init; } = new();
    public Dictionary<string, decimal> LatencyByDevice { get; init; } = new();
    public List<HourlySyncMetrics> HourlyMetrics { get; init; } = new();
...
public record ConnectedDevice
{
    ...
    public Dictionary<string, object> DeviceMetadata { get; init; } = new();
}
...
public record DisconnectResult
{
    ...
    public List<string> RemovedSubscriptions { get; init; } = new();
    public List<string> Errors { get; init; } = new();
    public TimeSpan ConnectionDuration { get; init; }
}
...
public record SyncPerformanceMetrics
{
    ...
    public Dictionary<string, DevicePerformanceMetrics> DeviceMetrics { get; init; } = new();
}
