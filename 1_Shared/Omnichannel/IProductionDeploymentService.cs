namespace VanAn.Shared.Omnichannel
{
    ...
    public record DeploymentResult
    {
        ...
        public List<ServiceDeploymentResult> ServiceResults { get; init; } = [];
    ...
    public record DeploymentStatus
    {
        ...
        public List<ServiceStatus> ServiceStatuses { get; init; } = [];
        public SystemHealth OverallHealth { get; init; }
        public Dictionary<string, object> Metrics { get; init; } = [];
        public List<string> ActiveDeployments { get; init; } = [];
    ...
    public record HealthCheckResult
    {
        ...
        public List<ServiceHealthCheck> ServiceChecks { get; init; } = [];
        public List<DependencyHealthCheck> DependencyChecks { get; init; } = [];
        public List<InfrastructureHealthCheck> InfrastructureChecks { get; init; } = [];
    ...
    public record SystemMetrics
    {
        ...
        public Dictionary<string, ServiceMetrics> ServiceMetrics { get; init; } = [];
    ...
    public record ErrorMetrics
    {
        ...
        public decimal ErrorRate { get; init; }
        public Dictionary<string, int> ErrorsByService { get; init; } = [];
        public Dictionary<string, int> ErrorsByType { get; init; } = [];
        public List<ErrorTrend> ErrorTrends { get; init; } = [];
    ...
    {
        public List<PerformanceTrend> PerformanceTrends { get; init; } = [];
        public List<ResourceTrend> ResourceTrends { get; init; } = [];
        public List<BusinessTrend> BusinessTrends { get; init; } = [];
        public List<ErrorTrend> ErrorTrends { get; init; } = [];
        public List<UserTrend> UserTrends { get; init; } = [];
    }
    ...
    {
        public List<ServiceScalingRequest> ServiceRequests { get; init; } = [];
        public ScalingStrategy Strategy { get; init; }
        public bool AutoScale { get; init; }
        public Dictionary<string, object> ScalingRules { get; init; } = [];
    ...
    public record ScalingResult
    {
        ...
        public List<ServiceScalingResult> ServiceResults { get; init; } = [];
        public List<string> Errors { get; init; } = [];
        public List<string> Warnings { get; init; } = [];
    ...
    public record RollbackResult
    {
        ...
        public List<ServiceRollbackResult> ServiceResults { get; init; } = [];
        public List<string> Errors { get; init; } = [];
        public List<string> Warnings { get; init; } = [];
    ...
    public record ValidationResult
    {
        ...
        public Dictionary<string, object> ValidationMetrics { get; init; } = [];
    ...
    public record EnvironmentConfiguration
    {
        ...
        public Dictionary<string, object> Monitoring { get; init; } = [];
        public Dictionary<string, object> Caching { get; init; } = [];
        public Dictionary<string, object> Security { get; init; } = [];
        public Dictionary<string, object> Performance { get; init; } = [];
    ...
    public record ConfigurationUpdateResult
    {
        ...
        public string UpdatedBy { get; init; } = string.Empty;
        public List<string> UpdatedSettings { get; init; } = [];
        public List<string> RestartedServices { get; init; } = [];
        public List<string> Errors { get; init; } = [];
        public List<string> Warnings { get; init; } = [];
        public string PreviousVersion { get; init; } = string.Empty;
        public string NewVersion { get; init; } = string.Empty;
    ...
    public record LoadTestRequest
    {
        ...
        public List<string> TargetServices { get; init; } = [];
        public List<string> TargetEndpoints { get; init; } = [];
        public Dictionary<string, object> TestParameters { get; init; } = [];
    ...
    public record LoadTestResult
    {
        ...
        public List<ServiceLoadTestResult> ServiceResults { get; init; } = [];
        public List<string> Errors { get; init; } = [];
        public List<string> Warnings { get; init; } = [];
        public bool PassedPerformanceThresholds { get; init; }
        public Dictionary<string, object> TestResults { get; init; } = [];
    }
    ...
    public record LoadTestMetrics
    {
        ...
        public decimal CpuUtilization { get; init; }
        public decimal MemoryUtilization { get; init; }
        public List<PerformanceTimeSeries> TimeSeries { get; init; } = [];
    }
    ...
    public record DeploymentAnalytics
    {
        ...
        public Dictionary<string, int> DeploymentsByService { get; init; } = [];
        public Dictionary<string, int> DeploymentsByDay { get; init; } = [];
        public List<DeploymentTrend> DeploymentTrends { get; init; } = [];
        public List<string> CommonErrors { get; init; } = [];
        public List<string> CommonWarnings { get; init; } = [];
    ...
    public record BackupResult
    {
        ...
        public List<string> BackedUpServices { get; init; } = [];
        public List<string> BackedUpDatabases { get; init; } = [];
    ...
    public record RestoreResult
    {
        ...
        public List<string> RestoredServices { get; init; } = [];
        public List<string> RestoredDatabases { get; init; } = [];
        public List<string> Errors { get; init; } = [];
        public List<string> Warnings { get; init; } = [];
        public string RequestedBy { get; init; } = string.Empty;
        public string? Reason { get; init; }
