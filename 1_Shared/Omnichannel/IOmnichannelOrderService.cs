...
public record OrderSyncResult
{
    ...
    public List<DeviceSyncError> FailedDevices { get; init; } = new();
...
public record OrderAnalytics
{
    ...
    public Dictionary<OrderStatusId, int> OrdersByStatus { get; init; } = new();
    public Dictionary<string, int> OrdersByDevice { get; init; } = new();
    public Dictionary<string, decimal> RevenueByDevice { get; init; } = new();
    public List<OrderMetrics> DailyMetrics { get; init; } = new();
...
public record OrderWorkflowStatus
{
    public Guid OrderId { get; init; }
    public string CurrentStep { get; init; } = string.Empty;
    public List<WorkflowStep> CompletedSteps { get; init; } = new();
    public List<WorkflowStep> PendingSteps { get; init; } = new();
