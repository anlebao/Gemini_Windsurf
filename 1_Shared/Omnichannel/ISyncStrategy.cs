namespace VanAn.Shared.Omnichannel
{
    ...
    public record SyncResult
    {
        ...
        public List<SyncConflict> ResolvedConflicts { get; init; } = [];
    ...
    public record SyncDelta
    {
        public string EntityType { get; init; } = string.Empty;
        public string EntityId { get; init; } = string.Empty;
        public List<PropertyDelta> PropertyDeltas { get; init; } = [];
    ...
    public record DataIntegrityResult
    {
        ...
        public string EntityType { get; init; } = string.Empty;
        public List<IntegrityViolation> Violations { get; init; } = [];
