...
public record ShopTemplate
{
    ...
    public required Collection<ProductTemplate> Products { get; init; } = new();
    public required Collection<IngredientTemplate> Ingredients { get; init; } = new();
    public required Collection<WorkflowStepTemplate> WorkflowSteps { get; init; } = new();
}
...
public record ProductTemplate
{
    ...
    public required Collection<string> Ingredients { get; init; } = new();
}
...
public record WorkflowStepTemplate
{
    ...
    public required Collection<string> RequiredRoles { get; init; } = new();
}
